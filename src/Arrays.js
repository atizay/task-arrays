...
export function arraySorting(data) {
    ...
    splitStr.map((numStr) => parseInt(numStr));
    splitStr.sort((a, b) => a - b);
    return Object.values(splitStr).toString();
}
...
export function arrayPushing(array1, array2) {
    ...
    while (array1.length > 0 && array2.length > 0) {
        unionArr.push(array1.shift(), array2.shift());
    }
    unionArr.push(...array1, ...array2);
    return unionArr;
}
